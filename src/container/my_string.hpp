...
namespace STL {
constexpr std::size_t STRING_MAX_SIZE = 999;
...
public:
  ...
  bool operator==(const My_String_Iterator &it) { return _ptr == it._ptr; }
  bool operator!=(const My_String_Iterator &it) { return _ptr != it._ptr; }
  char *_ptr;
};

template <typename alloc = Allocator<char>> class My_String {
public:
  ...
  ~My_String() { alloc::deallocate(_begin, _size); }
